...
- 2026-09-26：可以合并。第一轮测试同步问题已通过 2009da9 修正，原断言保留；主控复跑 workflow 为 17 passed、2 ignored，Clippy、diff 检查通过。
- 同意现有表单/按钮复用、仅 pending 可操作、相邻调序和成功选择保持的取舍；公开快照预检查不提供跨进程原子保证，已明确记录，不修改 drover。
- 完整两轮审查、失败证据及复核结论见 [T5-主控审查.md](T5-主控审查.md)。
